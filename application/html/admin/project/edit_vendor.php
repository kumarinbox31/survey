            ...
            <form id="contactForm" method="POST" action="" class="row">
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <select name="vendor" id="vendor" class="form-control select2 bg-white text-black" required>
                        ...
                        foreach ($get->result() as $key => $row) {
                            $selected = $vendor == $row->id ? 'selected' : '';
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <select name="vendor_contact" id="vendor_contact" class="form-control select2 bg-white text-black">
                        ...
                        $get = $this->db->query("SELECT * FROM `db_contact` WHERE company_type_id LIKE '" . '%"2"%' . "' ");
                        foreach ($get->result() as $key => $row) {
                            $selected = $company_type_id == $row->id ? 'selected' : '';
                            echo "<option value='$row->id' $selected>$row->display_name</option>";
                        }
                        ?>
                    </select>
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input class="form-control" id="cpc_cpi" type="number" name="cpc_cpi" required value="<?php echo $cpc_cpi;?>"/>
                </div>
                <div class="mb-3 col-md-6">
                    <label class="form-label required" for="reg">Reg.</label>
                    <input class="form-control" id="reg" type="text" name="req_complete" required value="<?php echo $req_complete;?>"/>
                </div>
                <div class="mb-3 col-md-12">
                    <label class="form-label" for="surveyRedirects">Survey redirects:</label>
                    <textarea class="form-control" placeholder="Complete" id="note" name="complete_link"><?php echo $complete_link;?></textarea>
                </div>
                <div class="mb-3 col-md-12">
                    <!-- <label class="form-label" for="surveyRedirects">Survey redirects</label> -->
                    <textarea class="form-control" placeholder="Testminate" id="note" name="terminate_link"><?php echo $terminate_link;?></textarea>
                </div>
                <div class="mb-3 col-md-12">
                    <!-- <label class="form-label" for="surveyRedirects">Survey redirects</label> -->
                    <textarea class="form-control" placeholder="Quotaful" id="note" name="quota_full_link"><?php echo $quota_full_link;?></textarea>
                </div>
                ...
                <div class="mb-3 col-md-9">
                    ...
                    <textarea class="form-control" id="note" type="text" rows="4" name="note"><?php echo $note?></textarea>
                </div>
