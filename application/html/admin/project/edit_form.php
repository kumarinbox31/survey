...
<div class="row">
    ...
    <?php
    $project_id = AB_ENCODE($id);
    $complete_url = base_url("endcapture.php?a=1&sid=$project_id&uid=111");
    $terminate_url = base_url("endcapture.php?a=2&sid=$project_id&uid=222");
